    ...
    >
        ...
        <div className="w-full flex items-center justify-between md:justify-center">
            ...
            <div className="relative max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify">
                ...
                <p className="text-lg font-light text-gray-700 first-letter:pl-5 lg:text-[16px] sm:text-[14px]">{aboutText}</p>
                <a href="/srinivas-cv.pdf" download="" className="w-max flex items-center gap-x-2 mt-6 rounded-full border border-gray-300 bg-red-400 px-3 py-2 font-light text-white hover:bg-red-500 transition-colors">
